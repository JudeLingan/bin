...
backlight_step=$(($(cat $backlight_path/max_brightness)/100))
...
function get_brightness {
    echo $(($(cat $backlight_path/brightness)*100/$(cat $backlight_path/max_brightness)))
}
...
# Makes brightness go up or down
function raise_brightness {
    brightness=$(get_brightness)
    new_brightness=$(($(($brightness+$brightness_step+1))*$backlight_step))
